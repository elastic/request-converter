...
const peggyParser: { parse: any; SyntaxError: any; DefaultTracer?: any } = // Generated by Peggy 3.0.2.
  ...
  (function () {
    ...
    function peg$parse(input, options) {
      ...
      // @ts-ignore
      var peg$startRuleFunctions = { requests: peg$parserequests };
      // @ts-ignore
      var peg$startRuleFunction = peg$parserequests;
      ...
      var peg$f0 = function (m, ws1, u, ws2, o) {
        // @ts-ignore
        return [
          m,
          ws1.length === 0 ? undefined : u,
          ws2.length === 0 ? undefined : o,
        ];
      }; // @ts-ignore

      var peg$f1 = function (u) {
        // @ts-ignore
        return "/" + u.join("");
      }; // @ts-ignore

      var peg$f2 = function (b, t, e) {
        // @ts-ignore
        return e ? [b, ...t, e] : [b, ...t];
      }; // @ts-ignore

      var peg$f3 = function (b, t, e) {
        // @ts-ignore
        return e ? [b, ...t, e] : [b, ...t];
      }; // @ts-ignore
...
export type Request = [
  Literal,
  (Url | null) | undefined,
  (Object_1 | null) | undefined,
];
export type Url = string;
export type BeginObject = "{";
export type EndObject = "}";
export type BeginArray = "[";
export type EndArray = "]";
export type Colon = ":";
export type Comma = ",";
export type Ws = string[];
export type Object_1 = (
  | BeginObject
  | NonNullable<EndObject | null>
  | Tokens[number]
)[];
export type Array_1 = (
  | BeginArray
  | NonNullable<EndArray | null>
  | Tokens[number]
)[];
export type Tokens = Token[];
export type Token = Value | Colon | Comma;
export type Value = Literal | Number_1 | String_1 | Object_1 | Array_1;
export type Literal = string;
export type Number_1 = number;
export type DecimalPoint = ".";
export type Digit19 = string;
export type E = string;
export type Exp = [E, (Minus | Plus) | null, DIGIT[]];
