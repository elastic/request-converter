...
export const skip: Record<string, SkippedTest> = {
  ...
  "ed12eeadb4e530b53c4975dadaa06054": {
    reason: "example references non-existant `ecs_compatibility` query attribute",
  },
  ...
  "39ce44333d28ed2b833722d3e3cb06f3": {
    reason: "example references a non-existant `include_named_queries_score` query attribute",
  },
};
